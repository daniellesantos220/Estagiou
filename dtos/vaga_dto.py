...
from dtos.validators import validar_id_positivo, validar_string_obrigatoria
...
class CriarVagaDTO(BaseModel):
    ...
    _validar_titulo = field_validator("titulo")(
        validar_string_obrigatoria(nome_campo="Título", tamanho_minimo=5, tamanho_maximo=200)
    )
