...
class UsuarioLogado:
    ...
    def is_estudante(self) -> bool:
        """Verifica se o usuário é estudante."""
        return self.perfil == Perfil.ESTUDANTE.value

    def is_recrutador(self) -> bool:
        """Verifica se o usuário é recrutador."""
        return self.perfil == Perfil.RECRUTADOR.value
    ...
    def tem_perfil(self, *perfis: str) -> bool:
        ...
        Exemplo:
            if usuario.tem_perfil(Perfil.ADMIN.value, Perfil.RECRUTADOR.value):
                # lógica para admin ou recrutador
        """
