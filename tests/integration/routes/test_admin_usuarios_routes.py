...
class TestListarUsuarios:
    ...
    def test_listar_usuarios_requer_admin(self, estudante_autenticado):
        """Estudante não deve acessar listagem de usuários"""
...
class TestCadastrarUsuario:
    ...
    def test_get_cadastrar_requer_admin(self, estudante_autenticado):
        """Estudante não deve acessar formulário de cadastro"""
        response = estudante_autenticado.get(
    ...
    def test_cadastrar_usuario_com_perfil_recrutador(self, admin_autenticado):
...
class TestEditarUsuario:
    ...
    def test_get_editar_requer_admin(self, estudante_autenticado, criar_usuario):
        """Estudante não deve acessar formulário de edição"""
        ...
        # Estudante pode receber 200 mas sem permissão, ou redirect/403
...
class TestExcluirUsuario:
    ...
    def test_estudante_nao_pode_excluir_usuario(
        self, estudante_autenticado, criar_usuario
    ):
        """Estudante não deve poder excluir usuários"""
        criar_usuario("Outro Usuario", "outro@example.com", "Senha@123")
