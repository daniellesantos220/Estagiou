...
class TestCriarChamado:
    ...
    def test_get_formulario_cadastro(self, estudante_autenticado):
        """Usuário autenticado deve acessar formulário de cadastro"""
        response = estudante_autenticado.get("/chamados/cadastrar")
        assert response.status_code == status.HTTP_200_OK
        assert "chamado" in response.text.lower()

    def test_criar_chamado_com_dados_validos(self, estudante_autenticado):
    ...
    def test_criar_chamado_titulo_curto(self, estudante_autenticado):
    ...
    def test_criar_chamado_titulo_longo(self, estudante_autenticado):
    ...
    def test_criar_chamado_descricao_curta(self, estudante_autenticado):
    ...
    def test_criar_chamado_sem_prioridade(self, estudante_autenticado):
    ...
    def test_criar_chamado_prioridade_invalida(self, estudante_autenticado):
    ...
    def test_chamado_criado_com_status_aberto(self, estudante_autenticado):
        ...
        response = estudante_autenticado.get("/chamados/listar")
        assert response.status_code == status.HTTP_200_OK
...
class TestListarChamados:
    ...
    def test_listar_chamados_usuario(self, estudante_autenticado):
        """Usuário deve conseguir listar seus chamados"""
        response = estudante_autenticado.get("/chamados/listar")
        assert response.status_code == status.HTTP_200_OK
        assert "chamado" in response.text.lower()

    def test_usuario_ve_apenas_proprios_chamados(self, client, estudante_autenticado):
        """Usuário deve ver apenas seus próprios chamados"""
        # Este estudante já está autenticado como um usuário comum
...
class TestVisualizarChamado:
    ...
    def test_visualizar_proprio_chamado(self, estudante_autenticado):
        ...
        response = estudante_autenticado.get("/chamados/1/visualizar")
        assert response.status_code == status.HTTP_200_OK
        assert "Problema urgente" in response.text

    def test_visualizar_chamado_inexistente(self, estudante_autenticado):
...
class TestExcluirChamado:
    ...
    def test_excluir_proprio_chamado(self, estudante_autenticado):
    ...
    def test_excluir_chamado_inexistente(self, estudante_autenticado):
...
class TestAdminListarChamados:
    ...
    def test_usuario_comum_nao_acessa_admin_listagem(self, estudante_autenticado):
...
class TestAdminResponderChamado:
    ...
    def test_admin_acessa_formulario_responder(
        self, estudante_autenticado, admin_autenticado
    ):
    ...
    def test_usuario_comum_nao_pode_responder(self, estudante_autenticado):
...
class TestHistoricoInteracoes:
    ...
    def test_usuario_pode_responder_proprio_chamado(self, estudante_autenticado):
...
class TestErrosAdminChamados:
    ...
    def test_erro_ao_salvar_resposta(self, estudante_autenticado, admin_autenticado):
    ...
    def test_erro_ao_fechar_chamado(self, estudante_autenticado, admin_autenticado):
    ...
    def test_erro_ao_reabrir_chamado(self, estudante_autenticado, admin_autenticado):
...
class TestRateLimitChamados:
    ...
    def test_rate_limit_criar_chamado(self, estudante_autenticado):
    ...
    def test_rate_limit_responder_chamado(self, estudante_autenticado):
...
class TestExclusaoChamado:
    ...
    def test_excluir_chamado_nao_aberto(self, estudante_autenticado, admin_autenticado):
...
class TestValidacaoResposta:
    ...
    def test_resposta_invalida_validation_error(self, estudante_autenticado):
    ...
    def test_responder_chamado_inexistente(self, estudante_autenticado):
