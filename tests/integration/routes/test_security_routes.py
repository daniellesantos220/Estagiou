...
class TestEscalacaoPrivilegios:
    ...
    def test_estudante_nao_pode_acessar_admin_usuarios(self, estudante_autenticado):
        """Estudante não deve acessar painel de administração de usuários"""
    ...
    def test_estudante_nao_pode_criar_usuario_como_admin(self, estudante_autenticado):
        """Estudante não deve poder acessar endpoint de criação de usuário admin"""
    ...
    def test_recrutador_nao_pode_acessar_backups(self, recrutador_autenticado):
        """Recrutador não deve acessar área de backups (apenas admin)"""
    ...
    def test_recrutador_nao_pode_criar_backup(self, recrutador_autenticado):
        """Recrutador não deve poder criar backups"""
        response = recrutador_autenticado.post(
