...
class TestDashboard:
    ...
    def test_dashboard_requer_autenticacao(self, client):
        """Estudante não autenticado não pode acessar dashboard"""
        response = client.get("/usuario", follow_redirects=False)
        assert response.status_code == status.HTTP_303_SEE_OTHER

    def test_dashboard_usuario_estudante(self, estudante_autenticado):
        """Cliente autenticado pode acessar dashboard"""
        response = estudante_autenticado.get("/usuario")
        assert response.status_code == status.HTTP_200_OK

    def test_dashboard_exibe_dados_usuario(self, estudante_autenticado, usuario_teste):
    ...
    def test_dashboard_recrutador(self, recrutador_autenticado, recrutador_teste):
        """Recrutador autenticado pode acessar dashboard"""
        response = recrutador_autenticado.get("/usuario")
        assert response.status_code == status.HTTP_200_OK
        assert recrutador_teste["nome"] in response.text
...
class TestVisualizarPerfil:
    ...
    def test_visualizar_perfil_usuario_autenticado(
        self, estudante_autenticado, usuario_teste
    ):
        """Usuário autenticado deve ver seu perfil"""
        response = estudante_autenticado.get("/usuario/perfil/visualizar")
        assert response.status_code == status.HTTP_200_OK
        assert usuario_teste["nome"] in response.text
        assert usuario_teste["email"] in response.text

    def test_visualizar_perfil_usuario_nao_encontrado(self, estudante_autenticado):
        ...
        with patch("routes.usuario_routes.usuario_repo") as mock_repo:
            ...
            response = estudante_autenticado.get(
...
class TestEditarPerfil:
    ...
    def test_get_formulario_edicao_usuario_autenticado(self, estudante_autenticado):
        """Usuário autenticado deve acessar formulário de edição"""
        response = estudante_autenticado.get("/usuario/perfil/editar")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_editar_perfil_com_dados_validos(
        ...
        response_visualizar = estudante_autenticado.get("/usuario/perfil/visualizar")
    ...
    def test_editar_perfil_com_nome_vazio(self, estudante_autenticado, usuario_teste):
    ...
    def test_editar_perfil_com_email_invalido(self, estudante_autenticado):
    ...
    def test_editar_perfil_atualiza_sessao(self, estudante_autenticado, usuario_teste):
        """Editar perfil deve atualizar dados na sessão"""
        estudante_autenticado.post(
            "/usuario/perfil/editar",
    ...
    def test_get_editar_perfil_rate_limit(self, estudante_autenticado):
...
class TestAlterarSenha:
    ...
    def test_get_formulario_alterar_senha_usuario_autenticado(
        self, estudante_autenticado
    ):
        """Usuário autenticado deve acessar formulário de alteração de senha"""
        response = estudante_autenticado.get("/usuario/perfil/alterar-senha")
        assert response.status_code == status.HTTP_200_OK
    ...
    def test_alterar_senha_com_dados_validos(
        ...
        estudante_autenticado.get("/logout")
        response_login = estudante_autenticado.post(
            "/login",
    ...
    def test_alterar_senha_com_senha_atual_incorreta(self, estudante_autenticado):
    ...
    def test_alterar_senha_nova_igual_atual(self, estudante_autenticado, usuario_teste):
    ...
    def test_alterar_senha_nova_fraca(self, estudante_autenticado, usuario_teste):
    ...
    def test_get_alterar_senha_rate_limit(self, estudante_autenticado):
        """Rate limit deve bloquear acesso ao formulário"""
        with patch(
            "routes.usuario_routes.form_get_limiter.verificar", return_value=False
        ):
    ...
    def test_post_alterar_senha_rate_limit(self, estudante_autenticado):
...
class TestAtualizarFoto:
    ...
    def test_atualizar_foto_com_dados_validos(
        self, estudante_autenticado, foto_teste_base64
    ):
    ...
    def test_atualizar_foto_com_dados_invalidos(self, estudante_autenticado):
    ...
    def test_atualizar_foto_muito_grande(self, estudante_autenticado):
    ...
    def test_atualizar_foto_vazia(self, estudante_autenticado):
    ...
    def test_post_atualizar_foto_rate_limit(self, estudante_autenticado):
    ...
    def test_atualizar_foto_erro_io(self, estudante_autenticado):
    ...
    def test_atualizar_foto_erro_os(self, estudante_autenticado):
